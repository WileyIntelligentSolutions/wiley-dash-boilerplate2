...
from celery.result import AsyncResult  # disable for layout testing
# Don't touch this unless you need to import several functions
# to run on Celery:
...
# Note: First walk through config.py and edit as needed.
...
# Assigning callbacks to components that are generated by other callbacks
